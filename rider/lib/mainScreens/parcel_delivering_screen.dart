...
import 'package:rider/maps/map_utils.dart';
...
class _ParcelDeliveringScreenState extends State<ParcelDeliveringScreen>
{
  ...
  {
    /*double prev=double.parse(previousRiderEarnings) ;
    double perparcel=double.parse(perParcelDeliveryAmount);
    double sum=prev+perparcel;
    String riderNewTotalEarningAmount=sum.toString();*/
